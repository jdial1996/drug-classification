# Standardised script that runs everytime in our pipeline when there is a change in the data or code
import pandas as pd 
from sklearn.model_selection import train_test_split
from sklearn.pipeline import Pipeline
from sklearn.compose import ColumnTransformer # lets us link different pipelines together 
# Encoder is to used to encode categorical data 
from sklearn.preprocessing import StandardScaler, OrdinalEncoder# preproccessing = cleaning the data / preparing it for the model 
...
pipeline = Pipeline([
    ...
    ('model', RandomForestClassifier(n_estimators=100, random_state=125)) # data will end up here
])
